export const ENDPOINTS = {
    ...
    services: {
        ...
        getDates: { path: '/v1/client/companies/{companyId}/services/{id}/dates', auth: 'apiKey' as const },
    },
    resources: {
    ...
    subscriptions: {
        cart: {
            get: { path: '/client/companies/{companyId}/plugins/subscription/client/cart', auth: 'bearer' as const },
            add: { path: '/client/companies/{companyId}/plugins/subscription/client/cart', auth: 'bearer' as const },
            remove: { path: '/client/companies/{companyId}/plugins/subscription/client/cart/{itemId}', auth: 'bearer' as const },
            checkout: { path: '/client/companies/{companyId}/plugins/subscription/client/cart/checkout', auth: 'bearer' as const },
        },
        purchases: {
            list: { path: '/client/companies/{companyId}/plugins/subscription/client/purchases', auth: 'bearer' as const },
            get: { path: '/client/companies/{companyId}/plugins/subscription/client/purchases/{itemId}', auth: 'bearer' as const },
