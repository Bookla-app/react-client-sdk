...
import {
    ...
    PurchaseSubscriptionsResponse, SubscriptionContract, CompanySubscription,
...
export class ClientSubscriptionService {
    ...
    async getCart(companyId: string, options?: RequestOptions): Promise<SubscriptionCartResponse> {
